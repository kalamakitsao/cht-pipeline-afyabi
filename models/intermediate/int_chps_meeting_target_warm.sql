...
/*
  int_chps_meeting_target_warm: 1 if (hh_visited / total_households) >= 0.33.
  Reads from pre-computed int_household_visit_metrics_warm and int_households.
...
SELECT
    ...
    NOW() AS last_updated
FROM {{ ref('int_household_visit_metrics_warm') }} hv
